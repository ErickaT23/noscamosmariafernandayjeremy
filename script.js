...
document.getElementById('show-wishes').addEventListener('click', () => {
  ...
  document.getElementById('rsvp-message').innerText = "Para nosotros es muy importante que confirmes tu asistencia antes del 15 de diceimbre, o bien indicarnos si no podrás acompañarnos.";
